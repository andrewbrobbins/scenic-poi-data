...
console.log("  node build-fuel-ca-filter-brands.mjs && node build-fuel-ca-master.mjs && node build-fuel-ca-explorer-embed.mjs && node build-fuel-explorer-data.mjs");
