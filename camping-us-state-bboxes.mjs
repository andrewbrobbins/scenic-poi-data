/** Approximate WGS84 bboxes [south, west, north, east] for Overpass state queries. */
export const STATE_BBOXES = {
  AL: [30.14, -88.52, 35.01, -84.89],
  AK: [51.0, -179.5, 71.5, -129.0],
  ...
  MA: [41.24, -73.5, 42.89, -69.93],
  MI: [41.7, -90.42, 48.3, -82.41],
